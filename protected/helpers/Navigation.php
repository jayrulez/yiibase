...
class Menu extends CComponent
{
	...
	public function setHtmlOptions($htmlOptions, $mergeOld = false)
	{
		...
		{
			throw new CException(Yii::t('application','The html options must be an array.'));
		}
		if($mergeOld)
		{
	...
	protected function compareItems($itemA, $itemB)
	{
		if($itemA instanceof MenuItem && $itemB instanceof MenuItem)
		{
			...
			throw new CException(Yii::t('application','Both items must be instances of MenuItem or one of its children.'));
		}
	}
